...
EVENT_RULES: Dict[str, Dict[str, Rule]] = {
    "WASHER": {
        "COMPLETE": ("LG 세탁기 세탁 완료", "생활편의", "낮음", "LG 세탁기 세탁이 완료되었습니다."),
        "STATUS_CHECK": ("LG 세탁기 진행 상태 확인", "생활편의", "낮음", "LG 세탁기 진행 상태를 확인했습니다."),
        "LAUNDRY_LEFT": ("LG 세탁기 세탁물 방치", "생활편의", "주의", "LG 세탁기 세탁이 끝난 뒤 세탁물이 남아 있습니다. 세탁물을 꺼내주세요."),
        "TAKE_OUT_GUIDE": ("LG 세탁기 세탁물 꺼내기 안내", "생활편의", "낮음", "LG 세탁기 세탁물을 꺼낼 시간입니다."),
        "ERROR": ("LG 세탁기 에러 또는 케어 알림", "생활편의", "주의", "LG 세탁기에 확인이 필요한 알림이 있습니다."),
    },
    "TV": {
        "DANGER_POPUP": ("LG TV 위험 안내 출력", "안전", "위험", "LG TV 화면에 위험 안내를 표시합니다."),
        "EMERGENCY_POPUP": ("LG TV 긴급 도움 요청 팝업", "긴급", "긴급", "LG TV 화면에 긴급 도움 요청을 표시합니다."),
        "HOME_STATUS_SUMMARY": ("LG TV 집 상태 요약 화면 출력", "상태확인", "낮음", "LG TV 화면에 집 상태 요약을 표시합니다."),
        "GUARDIAN_STATUS_DISPLAY": ("LG TV 보호자 연결 상태 표시", "긴급", "긴급", "LG TV 화면에 보호자 연결 상태를 표시합니다."),
    },
    "RANGE": {
        "POWER_ON": ("LG 전기레인지 켜짐", "안전", "주의", "LG 전기레인지가 켜져 있습니다."),
        "BURNER_ON": ("LG 전기레인지 화구 사용 중", "안전", "주의", "LG 전기레인지 화구가 사용 중입니다."),
        "LONG_ON": ("LG 전기레인지 장시간 사용", "안전", "위험", "LG 전기레인지가 장시간 사용 중입니다. 확인이 필요합니다."),
        "OUTING_CHECK": ("외출 전 LG 전기레인지 확인 필요", "안전", "주의", "외출 전 LG 전기레인지 상태를 확인하세요."),
        "POWER_USAGE_HIGH": ("LG 전기레인지 전력 사용량 증가", "안전", "주의", "LG 전기레인지 전력 사용량이 증가했습니다."),
        "COOK_COMPLETE": ("LG 전기레인지 조리 완료", "생활편의", "낮음", "LG 전기레인지 조리가 완료되었습니다."),
        # 잔열은 제품 자체 표시가 가능하지만 ThinQ 앱 잔열 푸시 알림 근거는 약하므로 MVP 핵심 판단 이벤트에서는 제외.
    },
    "DOOR_SENSOR": {
        "DOOR_OPEN": ("도어센서 문 열림", "안전", "주의", "도어센서에서 문 열림이 감지되었습니다."),
        "DOOR_CLOSED": ("도어센서 문 닫힘", "상태확인", "낮음", "도어센서에서 문 닫힘이 감지되었습니다."),
        "LONG_OPEN": ("도어센서 장시간 문열림", "안전", "위험", "도어센서에서 문이 장시간 열려 있음이 감지되었습니다."),
        "OUTING_OPEN": ("도어센서 외출 중 문열림", "안전", "위험", "도어센서에서 외출 중 문 열림이 감지되었습니다."),
        "RETURN_HOME": ("도어센서 귀가 감지", "상태확인", "낮음", "도어센서에서 귀가가 감지되었습니다."),
        "LEAVE_HOME": ("도어센서 외출 감지", "상태확인", "낮음", "도어센서에서 외출이 감지되었습니다."),
    },
    "AIR_SENSOR": {
        "AIR_QUALITY_BAD": ("LG 공기질 센서 공기질 나쁨", "상태확인", "주의", "LG 공기질 센서에서 실내 공기질 나쁨이 감지되었습니다."),
        "PM_HIGH": ("LG 공기질 센서 미세먼지 높음", "상태확인", "주의", "LG 공기질 센서에서 미세먼지 농도 높음이 감지되었습니다."),
        "CO2_HIGH": ("LG 공기질 센서 이산화탄소 높음", "상태확인", "주의", "LG 공기질 센서에서 이산화탄소 농도 높음이 감지되었습니다. 환기가 필요합니다."),
        "TEMP_ABNORMAL": ("LG 공기질 센서 온도 이상", "상태확인", "주의", "LG 공기질 센서에서 실내 온도 이상이 감지되었습니다."),
        "HUMIDITY_ABNORMAL": ("LG 공기질 센서 습도 이상", "상태확인", "주의", "LG 공기질 센서에서 실내 습도 이상이 감지되었습니다."),
        "VENTILATION_NEEDED": ("LG 공기질 센서 환기 필요", "상태확인", "주의", "LG 공기질 센서가 실내 환기가 필요하다고 판단했습니다."),
    },
    "REFRIGERATOR": {
        "TEMP_CHECK": ("LG 냉장고 온도 확인", "상태확인", "낮음", "LG 냉장고 온도를 확인했습니다."),
        "TEMP_ABNORMAL": ("LG 냉장고 온도 이상", "상태확인", "위험", "LG 냉장고 온도 이상이 감지되었습니다."),
        "CARE_ALERT": ("LG 냉장고 에러 또는 케어 알림", "상태확인", "주의", "LG 냉장고에 확인이 필요한 알림이 있습니다."),
        "ENERGY_USAGE_CHECK": ("LG 냉장고 전력 사용량 확인", "상태확인", "낮음", "LG 냉장고 전력 사용량을 확인했습니다."),
        # 냉장고 문열림 알림은 모델별 지원 기능이므로 백엔드에서 지원 모델일 때만 해당 이벤트를 전달한다.
        "DOOR_OPEN": ("LG 냉장고 문열림", "상태확인", "주의", "LG 냉장고 문이 열려 있습니다."),
        "LONG_OPEN": ("LG 냉장고 문 장시간 열림", "상태확인", "위험", "LG 냉장고 문이 오래 열려 있습니다."),
    },
}
