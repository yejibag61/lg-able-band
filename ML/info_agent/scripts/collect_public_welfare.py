"""Collect central-government welfare services from a configured public API."""

from collector_utils import RAW_DATA_DIR
from env_utils import PUBLIC_WELFARE_API_URL, get_service_key
...
RESPONSE_TYPE_PARAM = ""
RESPONSE_TYPE_VALUE = ""
EXTRA_PARAMS = {"callTp": "L", "srchKeyCode": "003"}
...
def main() -> None:
    collect_welfare_api(
        api_url=_list_url(PUBLIC_WELFARE_API_URL) if PUBLIC_WELFARE_API_URL else "",
        detail_url=_detail_url(PUBLIC_WELFARE_API_URL) if PUBLIC_WELFARE_API_URL else "",
